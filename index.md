...
In 2018 I established the [BAS AI Lab](http://www.bas.ac.uk), through which I formed a research team and secured external funding to focus on Arctic sea ice forecasting. This resulted in my team developing the widely recognised [IceNet](http://icenet.ai) programme, which delivered the first AI-powered pan-Arctic sea ice forecasting model. IceNet represented a step-change in seasonal forecasting capabilities, and outperformed the leading dynamical model, particularly in predicting extreme sea ice events months in advance. 

The innovation of IceNet has delivered significant, tangible impact. One major real-world application is our collaboration with the World Wide Fund for Nature (WWF) and the Government of Nunavut, which resulted in the ability to predict critical sea ice freeze-up dates [and the onset of mass Caribou migration](https://www.bas.ac.uk/media-post/new-ai-tool-aids-caribou-conservation-in-a-changing-arctic/) and to facilitate effective management of polar bear surveys. This work was featured in a [2025 documentary](https://www.royal.uk/news-and-activity/2025-10-18/steve-backshalls-retraces-the-kings-steps-in-royal-arctic-challenge) with HRH King Charles III. The AI model was featured in [Wired Magazine](https://www.wired.com/story/as-the-arctic-warms-ai-forecasts-scope-out-shifting-sea-ice/), by [Nvidia](https://blogs.nvidia.com/blog/ai-model-predicts-sea-ice-loss/), and the core publication was ranked among the [25 most downloaded](https://www.nature.com/collections/afchdbedbe) Nature Communications articles across Earth and Environmental Sciences published in 2021. IceNet was also was showcased as an ["AI for Good"](https://www.linkedin.com/posts/scitechgovuk_aisafetysummit-aisafetysummit-activity-7125422735781961728-ucda/) exemplar by the UK government as part of the first International AI Safety Summit, 2023.

Since joining the Alan Turing Institute, I expanded my work into the domain of AI for weather forecasting and am now the Mission Director for [Environmental Forecasting](https://www.turing.ac.uk/research/environment-sustainability). I was one of the founding members of the [Aardvark Weather model](https://www.turing.ac.uk/blog/project-aardvark-reimagining-ai-weather-prediction) team, a revolutionary system that replaces the entire, complex, traditional weather forecasting pipeline with a single, novel deep learning architecture. Aardvark can ingest multimodal data (satellites, weather stations, weather balloons) and generate a ten-day global forecast at speeds thousands of times faster than previous existing systems - both traditional and AI-based - while running on a desktop computer. Over 50 media outlets published the news story. This technological breakthrough has secured financial support from the Gates Foundation to deploy Aardvark within West Africa where we are working with local meteorological services and university partners to upskill local expertise in regions where access to supercomputers is limited.

I am also one of two Senior Responsible Owners (SROs) for the [FastNet weather forecasting model](https://www.turing.ac.uk/research/research-projects/fastnet), providing oversight for the model, and I was a [senior author](https://arxiv.org/abs/2509.17601v1) on the 2025 pre-print involving collaboration across a 34-author team. This new AI model is being developed in partnership between the Alan Turing Institute and the UK Met Office, and is aiming to become the UK’s future operational weather forecasting model.

If you would like to connect, you can find me at [BlueSky](https://bsky.app/profile/scotthosking.bsky.social) and [LinkedIn](https://www.linkedin.com/in/scotthosking/)


## Career History
* [The Alan Turing Institute](https://www.turing.ac.uk/), UK
    * Mission Director for Environmental Forecasting, [Environment and Sustainability Grand Challenge](https://www.turing.ac.uk/research/environment-sustainability), 2024-
    * Co-Director Natural Environment, Turing Research and Innovation Cluster in Digital Twins ([TRIC-DT](https://www.turing.ac.uk/research/research-projects/tric-dt)), 2023-2024
