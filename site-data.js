...
const SITE_DATA = {
  ...
  projects: [
    ...
    },
    {
      ...
      details: {
        ...
        achievements: [
          ...
          "Prototype for Arctic navigation and route optimisation",
    ...
    },
    {
      ...
      details: {
        ...
        achievements: [
          "Supported by ARIA",
          "Downscaling precipitation over Greenland",
          "Optimised sensor placement to support early warning system",
        ],
      },
      links: []
    },
  ...
  publications: [
    { year: 2026, title: "FastNet: Improving the physical consistency of machine-learning weather prediction models through loss function design", authors: "Dunstan et al.", journal: "#", url: "#", highlight: true },
